  ...
  <div id="content">
    ...
    <form action="" method="post">
      <dl>
        ...
        <dd>
          <textarea name="message" cols="50" rows="5"><?php if(isset($_REQUEST['res'])){echo(htmlspecialchars($message,ENT_QUOTES));} ?></textarea>
...
<?php foreach($posts as $post): ?>
    ...
    <?php if($post['reply_message_id'] > 0): ?>
      <a href="view.php?id=<?php echo(htmlspecialchars($post['reply_message_id'])); ?>">返信元のメッセージ</a>
    <?php endif; ?>
